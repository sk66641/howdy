...
const AuthPage = () => {
  ...
  return (
    <div className="relative min-h-screen min-w-[300px] flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden">
      ...
      >
        ...
        <div className="hidden md:flex flex-col justify-center items-center bg-gradient-to-br from-blue-900/90 to-purple-900/90 w-1/2 p-10 text-white relative overflow-hidden">
          ...
          >
            <a href="https://www.github.com/sk66641" className="text-blue-200 hover:text-white transition-colors duration-300">
